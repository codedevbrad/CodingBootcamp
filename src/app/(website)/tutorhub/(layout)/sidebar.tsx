...
import { BookOpen, CheckCircle2, Boxes } from "lucide-react"
import HeaderLogo from "@/components/app/app"

const nav = [
  { label: "Dashboard",    href: "/tutorhub",   icon: BookOpen },
  { label: "My Profile",   href: "/tutorhub/profile", icon: CheckCircle2 },
  { label: "Students",  href: "/tutorhub/students",   icon: Boxes }, 
];
