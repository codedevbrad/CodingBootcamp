...
/*
    could take props from the parent component to display the profile.
    if so, dont use the useCurrentUserState hook and get the user from the props.
*/

export function ProfileDisplayedProps({ user }: { user: User }) {
    return (
...
export function ProfileDisplayed() {
